...
const CoverageSection = () => (
  <section id="area-atuacao" className="py-20 md:py-28 bg-secondary" aria-label="Área de atuação">
          ...
          <div className="flex flex-wrap gap-3 mb-8" role="list" aria-label="Cidades atendidas">
            {cities.map((city) => (
              <span
                key={city}
                role="listitem"
                className="inline-flex items-center gap-1.5 bg-card border rounded-full px-4 py-2.5 text-sm font-medium shadow-sm"
              >
